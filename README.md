...
- 地図に載せた船宿 6,418件（位置を求められず載せていないもの 556件）
- プラン 48,421件。料金のある船宿 3,680件、出船時刻のある船宿 1,572件、公式サイトへのリンクがある船宿 3,689件
- 公式サイトから料金・プランを読み取ったのは 1,240サイト（7,092プラン）
- 水産庁集計の遊漁船業者の登録数（令和8年3月31日時点 11,938業者）に対して約54%。都道府県別では、登録簿を公表している兵庫・福井・高知・岡山は登録数と同程度以上、栃木・岐阜は0件、埼玉・沖縄・秋田・青森は3割未満です（同じ業者の複数の船や、湖のガイドは別々に数えることがあるため、比は目安です）
